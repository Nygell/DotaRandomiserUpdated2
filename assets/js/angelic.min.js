$(document).ready(function() {
    $('input[type="checkbox"]').change(function() {
        for (var c = 0, a = 0; 3 > a; a++) $("#attribute" + (a + 1)).is(":checked") && c++;
        0 == c && (this.checked = !0)
    })
});
        ...
        for (var a = [
                [{
                    ...
                    },
                    {
                        ...
                        img: "arc_warden_lg.jpg",
                        localized_name: "Arc Warden",
                        attribute: "agi",
                        id: 113
                    }, {
                        img: "monkey_king_lg.jpg",
                        localized_name: "Monkey King",
                        attribute: "agi",
                        id: 114
                    }, {
                        img: "pangolier_lg.jpg",
                ...
                [{
                    ...
                    img: "winter_wyvern_lg.jpg",
                    localized_name: "Winter Wyvern",
                    attribute: "int",
                    id: 112
                }, {
                    img: "dark_willow_lg.jpg",
                ...
                img: "guardian_greaves_lg.jpg",
                cost: 1350,
                id: 50,
                qual: "common",
                localized_name: "Guardian Greaves"
            }, {
                img: "boots_of_travel_2_lg.jpg",
                cost: 1350,
                id: 50,
                qual: "common",
                localized_name: "Boots of Travel 2"
            }], f = $("#hero-img"), g = $("#boot-img"), h = [$("#item1-img"), $("#item2-img"), $("#item3-img"), $("#item4-img"), $("#item5-img")], e = [], b = 0; 3 > b; b++) $("#attribute" + (b + 1)).is(":checked") && e.push(b);
        b = e[Math.floor(Math.random() * e.length)];
        e = Math.floor(Math.random() * a[b].length);
        f.attr("src", "assets/img/Heroes/".concat(a[b][e].img));
        f.attr("title", a[b][e].localized_name);
        a = a[b][e].localized_name + " \n";
        f = Math.floor(Math.random() * d.length);
        g.attr("src", "assets/img/Boots/".concat(d[f].img));
        g.attr("title", d[f].localized_name);
        a += d[f].localized_name + " \n";
        for (b = 0; 5 > b; b++) d = Math.floor(Math.random() * c.length), h[b].attr("src", "assets/img/Items/".concat(c[d].img)), h[b].attr("title", c[d].localized_name),
            a += c[d].localized_name + " \n", c.splice(d, 1);
        $("#build-output").val(a)
    })
});